...
class Command {
  ...
  async executeButton(interaction) {
    ...
    var calloutSections = [];
    const result = await this.populateSections(interaction, maps, mapName, calloutSections);
    ...
    return await this.rest.createInteractionResponse(interaction, { type: type, data: { flags: 1 << 6, content: image, components: components } });
  }
}
